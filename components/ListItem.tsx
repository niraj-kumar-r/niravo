...
const ListItem: React.FC<ListItemProps> = ({ image, name, href }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute flex items-center justify-center p-4 transition bg-green-500 rounded-full opacity-0 right-5 drop-shadow-md group-hover:opacity-100 hover:scale-110">
